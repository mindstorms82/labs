...
tshark -i $2 -w $filename443.pcap -f "tcp port 443" -a duration:400 -T fields -e frame.number -e frame.time -e ip.src -e ip.dst -e tcp.srcport -e tcp.dstport -e frame.len -e tcp.flags -e dns.qry.name -E header=y -E separator=, -E occurrence=f> $csv443 |
