...
tshark -i $2 -w $filename443.pcap -f "tcp port 443" -a duration:20 -T fields -e frame.number -e  frame.time_relative -e ip.src -e ip.dst -e tcp.port -e frame.len -e tcp.flags  -E header=y -E separator=, -E quote=d -E occurrence=f> $csv443 |
